...
export const courses = [
  ...
  },
  {
    ...
    certificate: "Web Development",
    description:
      "This course will continue with the topics presented in WDD 231 Web Front-end Development I: Building websites with HTML, CSS, and Javascript. This course will have a stronger emphasis on Javascript development and mobile design as students create mobile web applications.",
    technology: ["HTML", "CSS", "JavaScript"],
    learningOutcome: [
  ...
  },
  {
    ...
    technology: ["JavaScript", "Node.js", "EJS"],
    learningOutcome: [
